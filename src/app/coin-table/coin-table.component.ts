...
export class CoinTableComponent implements OnInit {
  ...
  displayedColumns = ['rank', 'symbol', 'price', 'percent_change_1h', 'percent_change_24h', 'percent_change_7d'];
  ...
  async refreshTableData() {
    ...
    coins.forEach(coin => {
        coin.price = coin.quotes.USD.price;
        coin.percent_change_1h = coin.quotes.USD.percent_change_1h;
        coin.percent_change_24h = coin.quotes.USD.percent_change_24h;
        coin.percent_change_7d = coin.quotes.USD.percent_change_7d;
    });
